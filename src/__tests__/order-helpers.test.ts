  ...
  describe("buildOrder", () => {
    describe("buy order", async () => {
      it("0.1", async () => {
        ...
        const signedOrder = await buildOrder(wallet, contractConfig.exchange, chainId, orderData);
    ...
    describe("real cases", async () => {
      describe("0.1", async () => {
        ...
        it("correctly rounds price amounts for validity sell", async () => {
          ...
          expect(Number(orderData.takerAmount) / Number(orderData.makerAmount)).toEqual(0.5);
        });
      ...
      describe("0.01", async () => {
        ...
        it("correctly rounds price amounts for validity sell", async () => {
          ...
          expect(Number(orderData.takerAmount) / Number(orderData.makerAmount)).toEqual(0.56);
        });
      ...
      describe("0.001", async () => {
        ...
        it("correctly rounds price amounts for validity sell", async () => {
          ...
          expect(Number(orderData.takerAmount) / Number(orderData.makerAmount)).toEqual(0.056);
        });
      ...
      describe("0.0001", async () => {
        ...
        it("correctly rounds price amounts for validity sell", async () => {
          ...
          expect(Number(orderData.takerAmount) / Number(orderData.makerAmount)).toEqual(0.0056);
        });
    ...
    describe("real cases", async () => {
      describe("0.1", async () => {
        ...
        it("correctly rounds price amounts for validity buy", async () => {
          ...
          const price = roundDown(Number(orderData.makerAmount) / Number(orderData.takerAmount), 2);
      ...
      describe("0.01", async () => {
        ...
        it("correctly rounds price amounts for validity buy", async () => {
          ...
          expect(Number(orderData.makerAmount) / Number(orderData.takerAmount)).toBeGreaterThan(
            0.56,
          );
        });
      ...
      describe("0.001", async () => {
        ...
        it("correctly rounds price amounts for validity buy", async () => {
          ...
          const price = roundDown(Number(orderData.makerAmount) / Number(orderData.takerAmount), 6);
      ...
      describe("0.0001", async () => {
        ...
        it("correctly rounds price amounts for validity buy", async () => {
          ...
          const price = roundDown(Number(orderData.makerAmount) / Number(orderData.takerAmount), 8);
